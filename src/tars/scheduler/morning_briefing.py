...
PROMPT_TEMPLATE = (
    ...
    "\n"
    "*Training* — payload.training present. EXACTLY 3 lines, no bullets:\n"
    ...
    "  Line 3 REQUIRED if week_outline has entries: ``Week: Sun <X> · Mon "
    "<X> · Tue <X> · Wed <X> · Thu <X> · Fri <X> · Sat <X>`` — one or two "
    "words per day capturing workout type (e.g. `easy`, `rest`, "
    "`intervals`, `long`, `tempo`). Compact, single line, separator is "
    "`·`. Skip Line 3 ONLY if week_outline is empty.\n"
